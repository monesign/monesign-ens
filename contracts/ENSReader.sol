...
// This is the wrapper contract for calling PublicResolver getters. First use the node to fetch the resolver
// address from the registry, then query the resolver function. Registry Address needs to be provided on deployment
contract ENSReader {
    ENS internal ens;
